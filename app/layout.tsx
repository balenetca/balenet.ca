...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Construct services Ottawa",
    "innovation-first solutions",
    "professional cleaning Ottawa",
    "disaster recovery Gatineau",
    "construction services Ottawa",
    "janitorial services Gatineau",
    "water damage cleanup Ottawa",
    "fire restoration Gatineau",
    "mold remediation Ottawa",
    "demolition services Gatineau",
    "tenant fit-outs Ottawa",
